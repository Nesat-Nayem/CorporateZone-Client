...
export const getStaticPaths = async () => {
    ...
    export const getStaticProps = async (context) => {
        ...
        const res = await fetch(`https://murmuring-spire-15534.herokuapp.com/jobs/${id}`);
        const data = await res.json();
...
const jobdetails = ({data}) => {
    ...
    const { jobTitle, jobDescription, responsibilities, skills, companyName, companyEmail, companyWebsite, companySize, businessType, companyLogo, jobType, salary, location, jobTags, experience, since, lastDate, postedTime } = data;
    return (
        <>
            <main>
                <section className={`${main_head} py-20 px-2 md:px-10 lg:px-32`}>
                    <div>
                        <h1 className="text-white text-2xl font-semibold md:text-4xl">{jobTitle}</h1>
                ...
                <section className="w-11/12 grid grid-cols-3 gap-4 mx-auto my-10">
                    <div className="col-span-3 md:col-span-2 bottom-1 border-cyan-100 py-4 px-6 md:py-10 md:px-12 shadow-md rounded-sm">
                        <div>
                            ...
                            <p className="text-base font-sans text-gray-500">{jobDescription}</p>
                        </div>
                    ...
                    <div style={{height:"880px",borderBottom:"2px solid red"}} className="col-span-3 md:col-span-1 bottom-1 border-cyan-100 shadow-md rounded-sm">
                        <div>
                            ...
                            <div className="text-center pt-8 pb-12">
                                <img className="w-30 self-center inline-block" src={companyLogo} alt="ImageLogo" />
                                ...
                                <div className="flex justify-start items-center">
                                    <div className="ml-10">
                                        ...
                                        <span className="ml-8 mt-1 text-gray-400 inline-block">{postedTime.slice(0,10)}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start py-6 items-center">
                                    <div className="ml-10">
                                        ...
                                        <span className="ml-8 mt-1 text-gray-400 inline-block">{location}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start items-center">
                                    <div className="ml-10">
                                        ...
                                        <span className="ml-8 mt-1 text-gray-400 inline-block">{jobTitle}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start py-6 items-center">
                                    <div className="ml-10">
                                        ...
                                        <span className="ml-8 mt-1 text-gray-400 inline-block">{salary}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-start items-center">
                                    <div className="ml-10">
                                        ...
                                        <span className="ml-8 text-gray-400 mt-1 inline-block">{experience}</span>
                                    </div>
                                </div>
