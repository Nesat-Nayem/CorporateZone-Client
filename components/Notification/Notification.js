    ...
    return (
        <>
            <button
                ...
                {
                    notifications.length > 0 && <span className="relative -top-2 right-3">
            ...
            >
                <div className="ml-4 mb-2">
                    <h2 className="text-2xl font-semibold text-gray-700 tracking-wide mb-2">Notifications</h2>
                    <button
                        className="bg-[#42C2FF] text-white hover:bg-[#85F4FF] hover:text-black mx-1 px-2 py-1 rounded-2xl shadow-md text-semibold"
                    >
                        All
                    </button>
                    <button
                        className="bg-[#85F4FF] text-black hover:bg-[#42C2FF] hover:text-white mx-1 px-2 py-1 rounded-2xl shadow-md text-semibold"
                    >
                        Unread
                    </button>
                </div>
