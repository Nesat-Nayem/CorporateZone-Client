          ...
          <section>
            <div className="ml-0 md:ml-8 lg:ml-12 px-2">
                ...
                <div className="container">
                      <h2 className="mb-6 ml-1 font-semibold">Your Profile Complete: {complete}</h2>
                        <div className="progressbar-container">
                          <div className="progressbar-complete" style={{width: `${complete}`}}>
                            <div className="progressbar-liquid"></div>
                          </div>
                          <span className="progress text-white font-bold">{complete}</span>
                        </div>
                      </div>
                    </div>
                    <div className="container">
                      <h2 className="mb-6 ml-1 font-semibold">Your Profile Complete avarage:</h2>
