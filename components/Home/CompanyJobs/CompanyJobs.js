    ...
    return (
        <div className="my-5">
            <div className="md:flex justify-between items-center md:w-8/12 mx-auto company_heading relative my-20 px-3">
                <h3 className="text-3xl after:content-[''] after:ml-0.5 after:text-red-500 after:absolute after:border-t-2 after:w-20 after: after:border-cyan-500 after:top-11 after:left-4 after:bottom-0 after:right-0 font-medium text-slate-700">Top Hiring Companies</h3>
            ...
            <div className="md:flex justify-center items-center my-20 company_card w-9/12 mx-auto">
                ...
                <a href="#" className="text-slate-200 dark:text-slate-400 block md:w-3/4 mx-auto mt-3 text-sm font-semibold bg-cyan-500 p-2 rounded-lg hover:bg-cyan-600">
                    7 Openings 
                </a>
                </div>
                ...
                <h3 className="text-slate-900 dark:text-white mt-3 text-base font-medium tracking-tight">AmaZon</h3>
                <span className="text-slate-400 dark:text-white text-sm font-medium tracking-tight">(SouthAfrica)</span> <br />
                <a href="#" className="text-slate-200 dark:text-slate-400 block md:w-3/4 mx-auto mt-3 font-semibold text-sm bg-cyan-500 p-2 rounded-lg hover:bg-cyan-600">
                    7 Openings 
                </a>
                </div>
