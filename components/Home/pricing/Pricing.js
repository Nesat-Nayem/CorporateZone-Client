            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 lg:gap-12 text-center px-5 md:px-20 lg:px-32 py-10">
                <div className=" text-center pt-5 pb-10 shadow-md card card_1">
                    <div className='text-center'>
                        <h2 className='text-2xl font-semibold head_title relative'>BASIC PLAN</h2>
                        <h1 className='mt-10'>
                            <span className='inline-block text-3xl title shadow-md bg-blue-400'>
                                <span className='inline-block title_middle font-semibold'>$29</span>
                            </span>
                        </h1>
                    </div>
                ...
                <div className=" text-center pt-5 pb-10 shadow-md card card_2">
                    ...
                    <div className='text-center'>
                        <h2 className='text-2xl font-semibold head_titles relative'>PREMIUM PLAN</h2>
                        <h1 className='mt-10'>
                            <span className='inline-block text-3xl title shadow-md bg-red-500'>
                                <span className='inline-block title_middle font-semibold'>$59</span>
                            </span>
                        </h1>
                    </div>
                    <div className='pt-10 flex flex-col'>
                ...
                <div className=" text-center pt-5 pb-10 shadow-md card card_1">
                    <div className='text-center'>
                        <h2 className='text-2xl font-semibold head_title relative'>ADVANCED PLAN</h2>
                        <h1 className='mt-10'>
                            <span className='inline-block text-3xl title shadow-md bg-blue-400'>
                                <span className='inline-block title_middle font-semibold'>$99</span>
                            </span>
                        </h1>
                    </div>
                    <div className='pt-10 flex flex-col'>
            ...
            <style jsx>
                {
                    `
                      ...
                      .card_sticker{
                            ...
                            top: 9px;
                            right:0;
                            clip-path: polygon(100% 0%, 63% 52%, 100% 100%, 0 100%, 0% 50%, 0 0);
