          ...
          <div className="flex justify-center">
            <a href="#!" className="mr-6">
              <svg
                ...
                className="w-2.5 hover:text-blue-700"
                role="img"
            ...
            <a href="#!" className="mr-6">
              <svg
                ...
                data-prefix="fab"
                data-icon="twitter"
                className="w-4 hover:text-blue-500"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
            ...
            <a href="#!" className="mr-6">
              <svg
                ...
                data-prefix="fab"
                data-icon="google"
                className="w-3.5 hover:text-red-600"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 488 512"
              >
            ...
            <a href="#!" className="mr-6">
              <svg
                ...
                data-prefix="fab"
                data-icon="instagram"
                className="w-3.5 hover:text-red-500"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
            ...
            <a href="#!" className="mr-6">
              <svg
                ...
                className="w-3.5 hover:text-blue-500"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
              >
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="">
              ...
              <p className="text-sm">
                A powerful fusion of imagination, creativity, and
                professionalism! WEAST is the bridge between clients and
                potential customers, a formidable content creation outfit, with
                flexible, cost effective, and consistent content solutions.
                WEAST corporate content positions you businesses to excellence
                and success. Our expertise in diverse market settings, enables
                us to connect with your vision and goals.Our customer relations
                and services are exemplary.
              </p>
            </div>
